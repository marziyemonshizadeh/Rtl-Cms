...
const Sidebar: React.FC = () => {
  return (
    <>
      <h2 className="text-slate-50 font-extrabold text-lg p-3 border-solid border-b text-center md:text-right border-slate-50 ">
        به داشبورد خود خوش آمدید
      </h2>
      <ul className="text-slate-50 md:space-y-2 md:block grid grid-cols-3">
